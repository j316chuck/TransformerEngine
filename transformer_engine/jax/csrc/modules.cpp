...
pybind11::bytes PackCustomCallFusedAttnDescriptor(
    size_t batch_size, size_t q_max_seqlen, size_t kv_max_seqlen, size_t num_heads, size_t head_dim,
    size_t wkspace_size, float scaling_factor, float dropout_probability,
    NVTE_Bias_Type bias_type, NVTE_Mask_Type mask_type,  DType dtype, DType wkspace_dtype,
    bool is_training) {
    return PackOpaque(CustomCallFusedAttnDescriptor{
        batch_size, q_max_seqlen, kv_max_seqlen, num_heads, head_dim, wkspace_size,
...
pybind11::tuple GetCrossFusedAttnForwardWorkspaceSizes(
    ...
    auto kv_shape = std::vector<size_t>{batch_size * kv_max_seqlen, 2, num_heads, head_dim};
